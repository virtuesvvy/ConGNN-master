...
Train_txt_path = r'J:\geo_affective\cross_validation\txt\scene\site_train4_16.txt'
Val_txt_path = r'J:\geo_affective\cross_validation\txt\scene\site_test4_16.txt'
# 数据集加载方式设置
