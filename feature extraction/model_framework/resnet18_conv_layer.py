...
resnet18_conv = resnet18().cuda()

# summary(resnet18_conv, (3, 224,224))

# 加载 imagenet 参数   要先加载预训练参数，再改变输入图片通道数  否则出错
resnet18 = models.resnet18(pretrained=True)
pretrained_dict = resnet18.state_dict()
model_dict = resnet18_conv.state_dict()
pretrained_dict = {k: v for k, v in pretrained_dict.items() if k in model_dict}
model_dict.update(pretrained_dict)
resnet18_conv.load_state_dict(model_dict)

#改变输入图片通道数
# resnet18_conv.conv1 = nn.Conv2d(1, 64, kernel_size=7, stride=2, padding=3,bias=False)
