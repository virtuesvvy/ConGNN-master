from load_imgs_face import test_loader,train_loader,num_of_trainData
...
# pretrained_dict = torch.load('model_weights/group_face_resnet50_53.57.pth')
...
for epoch in range(num_epoches):
    ...
    if max_acc < int(test_acc) / test_count:
        ...
        torch.save(extract_model.state_dict(), 'J:/geo_affective/preprocess/new_site/weights/cross/feature/face/4/new_site_face_ep{} {}.pth'.format(epoch,int(test_acc) / test_count))
