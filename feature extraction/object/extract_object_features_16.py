...
from model_framework.resnet50_conv_layer import resnet_50
...
# to_org_path = r'E:\pky\GANN\features\label_face'

# h5f_data = h5py.File('features/face_resnet50_train.h5', 'w')
# i = 0
# feature = []
# label_list = []
...
#     path=img_path[0]
#     name = path.split('\\')
#     save_folder = to_org_path + os.sep + name[5]+ os.sep +name[6]
...
h5f_data = h5py.File('features/sites_object16_senet50_train.h5', 'w')
i = 0
feature = []
label_list = []
for data in train_loader:
    ...
    xx = np.array(wenjian[4] + wenjian[5] + wenjian[6])

    if i % 16 == 0:
        # xxx = np.array(feature)
        print(xx)
...
h5f_data = h5py.File('features/sites_object16_senet50_test.h5', 'w')
i = 0
feature = []
label_list = []
